...
|---|---:|---|---|
| `PCS_ENABLE_SCHEDULER_LOG_DELIVERY` | `1` | `/aws/pcs/<cluster>/scheduler` | Scheduler operation and failure logs |
| `PCS_ENABLE_JOB_COMPLETION_LOG_DELIVERY` | `1` | `/aws/pcs/<cluster>/job-completion` | Completed-job state, requested/allocated resources, and exit details |
| `PCS_ENABLE_SCHEDULER_AUDIT_LOG_DELIVERY` | `0` | `/aws/pcs/<cluster>/scheduler-audit` | Slurm RPC audit logs for compliance or focused investigation |
